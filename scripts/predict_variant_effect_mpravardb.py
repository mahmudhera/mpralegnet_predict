...
def main() -> None:
    ...
    inp.add_argument("--input", type=str, required=True, help="csv with sequences where columns are chr,pos,ref,alt,genome,rsid,cellline,log2FC,pvalue,fdr,MPRA_study,ref_seq,alt_seq")
